    ...
    switch ($pg) {
                ...
                $img = $_FILES["img"]['name'] == "" ? "" : time() . '_' . basename($_FILES["img"]["name"]);
                           ...
                           if(!empty($name) && !empty($mota) && !empty($iddm)  ) {
                               ...
                               if(!empty($size) && !empty($color) && !empty($prices)){
                                      sanpham_update($name, $img, 0, $mota, $iddm, $id,$soluong,$isBestSeller);
                                      varible_delete($id);
                                      ...
                                      sanpham_update($name, $img, $price, $mota, $iddm, $id,$soluong,$isBestSeller);
                                  }
        ...
        case 'addproduct':
            if (isset($_POST['addproduct'])) {
                ...
                $mota = $_POST['mota'];
                $soluong = $_POST['soluong'];
                $isSeller = $_POST['isBestSeller'];
                $iddm = $_POST['iddm'] == 0 ? '' : $_POST['iddm'];
                $img = time() . '_' . basename($_FILES["img"]["name"]);
                if(!empty($name) && !empty($price) && !empty($mota) && !empty($iddm)  && !empty($img) && !empty($soluong)&& !empty($isSeller)  ) {
                    if(!empty($size) && !empty($color) && !empty($prices)){
                        $id = sanpham_insert($name, $img, 0, $mota, $iddm,$soluong,$isSeller);
                        $colors = json_decode($color);
                        $size = json_decode($size);
                        $prices = json_decode($prices);
                        $priceIndex = 0;
                        ...
                        $id = sanpham_insert($name, $img, $price, $mota, $iddm,$soluong,$isSeller);
                    }
                    //Insert into

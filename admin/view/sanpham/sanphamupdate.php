...
<div class="page-content dark:bg-zinc-700">
            <div class="container-fluid px-[0.625rem]">
                ...
                <form class="addPro" action="index.php?pg=updateproduct" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="isBestSeller">Thuộc sản phẩm:</label>
                        <select class="dark:bg-zinc-800 dark:border-zinc-700 w-full rounded border-gray-100 py-2.5 text-sm text-gray-500 focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:text-zinc-100/60" name="isBestSeller" aria-label="Default select example">
                            <option value="1" <?=$isBestSeller == 1 ? 'selected' : '';?> >Nổi bật</option>
                            <option value="0" <?=$isBestSeller == 2 ? 'selected' : '';?>>Không</option>
                          </select>
                    </div>

...
//////////////////////DANG KY, DANG NHAP/////////////////                
           ...
           // Kiểm tra xem 's_user' có tồn tại trong $_SESSION không
if (isset($_SESSION['s_user']) && isset($_SESSION['s_user']['id'])) {
    $listbill = loadall_bill($_SESSION['s_user']['id']);
    include "view/mybill.php";
} else {
    // Nếu chưa đăng nhập, có thể redirect hoặc hiển thị thông báo lỗi
